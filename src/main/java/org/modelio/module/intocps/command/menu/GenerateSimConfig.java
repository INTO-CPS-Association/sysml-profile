...
import org.modelio.module.intocps.ui.ConfigurationWizardExport;
 ...
 *
 */
public class GenerateSimConfig extends DefaultModuleCommandHandler {


    /**
     * Constructor.
     */
    public GenerateSimConfig() {
        super();
    }
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        ConfigurationWizardExport export = new ConfigurationWizardExport(Display.getCurrent().getActiveShell(), module);
