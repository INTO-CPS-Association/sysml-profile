...
import org.modelio.module.intocps.ui.DSEWizardExport;
 ...
 *
 */
public class GenerateDSE extends DefaultModuleCommandHandler {
	...
	public boolean accept(List<MObject> selectedElements, IModule module) {
		...
		return ((selectedElements.size() == 1)
				...
				&& ((Class) selectedElements.get(0)).isStereotyped(IINTOCPSPeerModule.MODULE_NAME, INTOCPSStereotypes.DSEANALYSIS));
	}
	...
	public void actionPerformed(List<MObject> selectedElements, IModule module) {
		...
		DSEWizardExport export = new DSEWizardExport(Display.getCurrent().getActiveShell(), module);
