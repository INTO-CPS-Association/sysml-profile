 ...
 *
 */
public class DSEParameterDefinitionDiagramCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        String name = "DSE Parameter Definition Diagram";
        Stereotype sterArchi = session.getMetamodelExtensions().getStereotype(IINTOCPSPeerModule.MODULE_NAME,
                INTOCPSStereotypes.DSEPARAMETERDEFINITIONDIAGRAM, moduleContext.getModelioServices().getMetamodelService().getMetamodel().getMClass(ClassDiagram.class));
