...
/**
 * This class handles the creation of INTOCPS Architecture diagram
 * @author ebrosse
 *
 */
public class ArchitectureStructureDiagramCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        String name = "Architecture diagram";
        Stereotype sterArchi = session.getMetamodelExtensions().getStereotype(IINTOCPSPeerModule.MODULE_NAME,
                INTOCPSStereotypes.ARCHITECTUREDIAGRAM, moduleContext.getModelioServices().getMetamodelService().getMetamodel().getMClass(ClassDiagram.class));
