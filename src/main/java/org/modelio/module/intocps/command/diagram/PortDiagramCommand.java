 ...
 *
 */
public class PortDiagramCommand extends DefaultBoxTool {

    /**
     * Default constructor
     */
    public PortDiagramCommand() {
        super();
    }
    ...
    public void actionPerformed(IDiagramHandle representation, IDiagramGraphic target, Rectangle rect) {
        ...
        try (ITransaction transaction = session.createTransaction(I18nMessageService.getString("Info.Session.Create", "IntoCPS Port"))) {
            MObject element = target.getElement();
