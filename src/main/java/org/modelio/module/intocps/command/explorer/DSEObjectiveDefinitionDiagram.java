 ...
 *
 */
public class DSEObjectiveDefinitionDiagram extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        String name = "DSE Objective Definition diagram";
        Stereotype sterArchi = session.getMetamodelExtensions().getStereotype(IINTOCPSPeerModule.MODULE_NAME,
                INTOCPSStereotypes.DSEOBJECTIVEDEFINITIONDIAGRAM, moduleContext.getModelioServices().getMetamodelService().getMetamodel().getMClass(ClassDiagram.class));
