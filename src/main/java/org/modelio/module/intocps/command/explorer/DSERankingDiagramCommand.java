 ...
 *
 */
public class DSERankingDiagramCommand extends DefaultModuleCommandHandler {
    ...
    public void actionPerformed(List<MObject> selectedElements, IModule module) {
        ...
        String name = "DSE Ranking diagram";
        Stereotype sterArchi = session.getMetamodelExtensions().getStereotype(IINTOCPSPeerModule.MODULE_NAME,
                INTOCPSStereotypes.DSERANKINGDIAGRAM, moduleContext.getModelioServices().getMetamodelService().getMetamodel().getMClass(ClassDiagram.class));
