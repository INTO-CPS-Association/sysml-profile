 ...
 *
 */
public class ConnectionDiagramWizard extends AbstractWizardContributor implements IDiagramWizardContributor {
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        MClass mClass = metamodel.getMClass(ObjectDiagram.class);
        IMetamodelExtensions extensions = moduleContext.getModelingSession().getMetamodelExtensions();
        Stereotype stereotype = extensions.getStereotype(IINTOCPSPeerModule.MODULE_NAME, INTOCPSStereotypes.CONNECTIONDIAGRAM, mClass);
