 ...
 *
 */
public class DSEObjectiveConnectionDiagramWizard extends AbstractWizardContributor implements IDiagramWizardContributor {
    ...
    public AbstractDiagram actionPerformed(ModelElement element, String diagramName,
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create","DSE Objective Connection Diagram"))){

            IModelioServices modelioServices = context.getModelioServices();

            diagram = session.getModel().createClassDiagram("connection diagram",
                    element,
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(IINTOCPSPeerModule.MODULE_NAME, INTOCPSStereotypes.DSEOBJECTIVECONNECTIONDIAGRAM, mClass);
