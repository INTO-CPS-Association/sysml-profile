 ...
 *
 */
public class DSERankingDiagramWizard extends AbstractWizardContributor implements IDiagramWizardContributor {
    ...
    public AbstractDiagram actionPerformed(ModelElement element, String diagramName,
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create","DSE Ranking Diagram"))){

            IModelioServices modelioServices = context.getModelioServices();

            diagram = session.getModel().createClassDiagram("ranking diagram",
                    element,
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(IINTOCPSPeerModule.MODULE_NAME, INTOCPSStereotypes.DSERANKINGDIAGRAM, mClass);
