 ...
 *
 */
public class DSEParameterConnectionDiagramCustomizer extends INTOCPSDiagramCustomizer implements IDiagramCustomizer {
    ...
    private PaletteEntry createClassGroup(final IDiagramService toolRegistry) {
        final PaletteDrawer group = new PaletteDrawer("Parameter Connection", null);
