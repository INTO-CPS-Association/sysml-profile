 ...
 *
 */
public class DSEObjectiveDefinitionDiagramCustomizer extends INTOCPSDiagramCustomizer implements IDiagramCustomizer {
    ...
    private PaletteEntry createClassGroup(final IDiagramService toolRegistry) {
        final PaletteDrawer group = new PaletteDrawer("Objective");
        group.add(toolRegistry.getRegisteredTool(IINTOCPSCustomizerPredefinedField.DSEAnalysis));
        group.add(toolRegistry.getRegisteredTool(IINTOCPSCustomizerPredefinedField.ExternalScript));
