 ...
 *
 */
public class DSEObjectiveConnectionDiagramCustomizer extends INTOCPSDiagramCustomizer implements IDiagramCustomizer {
    ...
    private PaletteEntry createClassGroup(final IDiagramService toolRegistry) {
        final PaletteDrawer group = new PaletteDrawer("Objective Connection", null);

        group.add(toolRegistry.getRegisteredTool(IDiagramCustomizerPredefinedField.BindableInstance));
        group.add(toolRegistry.getRegisteredTool(IINTOCPSCustomizerPredefinedField.Reference));
