 ...
 *
 */
public class DSEParameterConnectionDiagramWizard extends AbstractWizardContributor implements IDiagramWizardContributor {
    ...
    public AbstractDiagram actionPerformed(ModelElement element, String diagramName,
        ...
        try( ITransaction transaction = session.createTransaction (I18nMessageService.getString ("Info.Session.Create","DSE Parameter Connection Diagram"))){

            IModelioServices modelioServices = context.getModelioServices();

            diagram = session.getModel().createClassDiagram("parameter connection diagram",
                    element,
    ...
    public ElementDescriptor getCreatedElementType() {
        ...
        Stereotype stereotype = extensions.getStereotype(IINTOCPSPeerModule.MODULE_NAME, INTOCPSStereotypes.DSEPARAMETERCONNECTIONDIAGRAM, mClass);
