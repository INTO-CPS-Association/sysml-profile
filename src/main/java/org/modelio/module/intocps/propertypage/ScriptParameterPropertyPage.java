 ...
 *
 */
public class ScriptParameterPropertyPage implements IPropertyContent{
	 ...
	 * Default constructor
	 */
	public ScriptParameterPropertyPage(){}


	@Override
	public void update(ModelElement element, IModulePropertyTable table) {

		String value = ModelUtils.getTaggedValue(INTOCPSTagTypes.SCRIPTPARAMETER_PORT_VALUE, element);
	...
	public void changeProperty(ModelElement element, int row, String value) {
		if(row == 1){
			ModelUtils.addValue(IINTOCPSPeerModule.MODULE_NAME, INTOCPSTagTypes.SCRIPTPARAMETER_PORT_VALUE, value, element);
		}
	}
