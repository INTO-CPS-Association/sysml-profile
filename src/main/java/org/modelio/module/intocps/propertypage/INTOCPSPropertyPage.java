 ...
 * This class extends
 */
public class INTOCPSPropertyPage extends AbstractModulePropertyPage {
    ...
    public INTOCPSPropertyPage(IModule module, String name, String label, String bitmap) {
    ...
    public void changeProperty(List<MObject> selectedElements, int row, String value) {
        if ((selectedElements != null) && (selectedElements.size() > 0) && (selectedElements.get(0) instanceof ModelElement)){
            ...
            INTOCPSPropertyManager sysMLPage = new INTOCPSPropertyManager();
