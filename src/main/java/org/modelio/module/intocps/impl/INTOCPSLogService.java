 ...
 */
public class INTOCPSLogService {
     ...
     * @param module the current instance of {@link INTOCPSModule}.
     */
    public INTOCPSLogService(ILogService logService, INTOCPSModule module) {
